...
import { SystemServiceClient } from "../../../proto/shop/system.pbsc";
...
export class SystemService {
  ...
  constructor(private loadingBar: LoadingBarService, private commonService: CommonService, private cookieService: CookieService, private loaderService: LoaderService) {
    ...
    this.systemServiceClient = new SystemServiceClient(null, grpcClientFactory, grpcHandler);
  }

  updateSystemService(req: UpdateSystemServiceRequest) {
    ...
    return this.systemServiceClient
      .updateSystemService(req, this.metadata)
      .toPromise()
      .finally(() => {
  ...
  getSystemService(req: googleProtobuf001.Empty) {
    this.loadingBar.start();
    this.loaderService.show(); // flag
    this.commonService.loaderEmitter.emit(true);
    ...
    return this.systemServiceClient
      .getSystemService(req, this.metadata)
      .toPromise()
      .finally(() => {
        this.loadingBar.stop();
        this.loaderService.hide();
