...
/**
 * Message implementation for products.LoginRequest
 */
export class LoginRequest implements GrpcMessage {
  static id = 'products.LoginRequest';
...
/**
 * Message implementation for products.LoginResponse
 */
export class LoginResponse implements GrpcMessage {
  static id = 'products.LoginResponse';
