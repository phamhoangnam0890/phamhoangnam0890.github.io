...
/**
 * Service client implementation for shop.LoginService
 */
...
export class LoginServiceClient {
  ...
  $raw = {
    /**
     * Unary call: /shop.LoginService/Login
     *
  ...
  constructor(
    ...
    this.client = clientFactory.createClient('shop.LoginService', settings);
  }
